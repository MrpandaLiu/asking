...
import Vue from 'vue';
import { Uploader,Field,CellGroup,Button,RadioGroup,Radio,Notify } from 'vant';
UseComponents(Vue,Uploader,Field,CellGroup,Button,RadioGroup,Radio,Notify);
...
export default {
    ...
    methods: {
        afterRead() {
            ...
            this.formData.append("username",'123@qq.com');
